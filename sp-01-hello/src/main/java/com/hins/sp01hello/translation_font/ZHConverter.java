package com.hins.sp01hello.translation_font;
...
public class ZHConverter {
    ...
    static {
        propertyFiles[TRADITIONAL] = "/font_zh/zh2Hant.properties"; //附件下载
        propertyFiles[SIMPLIFIED] = "/font_zh/zh2Hans.properties";  //附件下载
    }
