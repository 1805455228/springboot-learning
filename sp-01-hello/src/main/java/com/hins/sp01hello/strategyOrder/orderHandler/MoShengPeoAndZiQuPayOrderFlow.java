...
@Slf4j
@Service
@OrderSceneAnnotation(orderType = GroupTypeEnum.GROUP_TWO, groupWay = GroupWayEnum.TAKE_ONESELF)
public class MoShengPeoAndZiQuPayOrderFlow implements OrderPayStrategyInterface {
