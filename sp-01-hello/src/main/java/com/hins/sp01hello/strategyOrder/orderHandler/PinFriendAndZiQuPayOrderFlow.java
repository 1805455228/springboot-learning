...
@Slf4j
@Service
@OrderSceneAnnotation(orderType = GroupTypeEnum.GROUP_FRIEND, groupWay = GroupWayEnum.TAKE_ONESELF)
public class PinFriendAndZiQuPayOrderFlow implements OrderPayStrategyInterface {
