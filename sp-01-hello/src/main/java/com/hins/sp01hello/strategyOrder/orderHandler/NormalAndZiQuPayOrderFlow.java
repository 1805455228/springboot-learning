...
@Slf4j
@Service
@OrderSceneAnnotation(orderType = GroupTypeEnum.NORMAL, groupWay = GroupWayEnum.TAKE_ONESELF)
public class NormalAndZiQuPayOrderFlow implements OrderPayStrategyInterface {
