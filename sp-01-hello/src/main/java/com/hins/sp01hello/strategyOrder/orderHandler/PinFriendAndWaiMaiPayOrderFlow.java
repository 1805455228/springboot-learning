...
@Service
@Slf4j
@OrderSceneAnnotation(orderType = GroupTypeEnum.GROUP_FRIEND, groupWay = GroupWayEnum.TAKE_OUT)
public class PinFriendAndWaiMaiPayOrderFlow implements OrderPayStrategyInterface{
