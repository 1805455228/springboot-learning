package com.hins.sp05swagger2.api;

import com.hins.sp05swagger2.entity.BaseResult;
import com.hins.sp05swagger2.entity.User;
...
public class UserController {
    ...
    public BaseResult<User> putUser(@PathVariable Integer id, @ApiIgnore User user) {
        User u = users.get(id);
