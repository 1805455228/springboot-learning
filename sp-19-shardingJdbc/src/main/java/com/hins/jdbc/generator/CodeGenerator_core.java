...
public class CodeGenerator_core {
...
//        DataSourceConfig dsc = new DataSourceConfig();
//        dsc.setUrl("jdbc:mysql://172.16.16.8:3306/cloud_course?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
//        // dsc.setSchemaName("public");
//        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
//        dsc.setUsername("root");
//        dsc.setPassword("root@yingxinnet");
//        mpg.setDataSource(dsc);
...
//        templateConfig.setController(null);
        ...
        strategy.setSuperEntityClass("com.hins.jdbc.common.BaseEntity");
        ...
        // 公共父类
        strategy.setSuperControllerClass("com.hins.jdbc.common.BaseController");
...
//        strategy.setTablePrefix("test_");//根据表前缀写死-- 订单模块
//        strategy.setTablePrefix("school_");//根据表前缀写死-- 教师、家长、学生
