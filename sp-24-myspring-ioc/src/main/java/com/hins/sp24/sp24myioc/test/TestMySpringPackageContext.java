...
import com.hins.sp24.sp24myioc.context.MySpringPackageContext;

/**
 * 测试通过包扫描加载
 */
public class TestMySpringPackageContext {
    public static void main(String[] args) {
        MySpringPackageContext context= new MySpringPackageContext("com.hins.sp24.sp24myioc");
        context.overview();
